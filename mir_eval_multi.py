...
def match_notes(
        ref_intervals, ref_pitches, ref_instruments, est_intervals, est_pitches,
        est_instruments, onset_tolerance=0.05, pitch_tolerance=50.0,
        offset_ratio=0.2, offset_min_tolerance=0.05, strict=False,
        velocity_tolerance=0.1):
    """Match notes, taking instruments into consideration.
    ...
    ref_matched_instruments = ref_instruments[matching[:, 0]]
    est_matched_instruments = est_instruments[matching[:, 1]]
    ...
    matching = matching[ref_matched_instruments == est_matched_instruments]
...
def precision_recall_f1_overlap(
    ...
    """
    validate(ref_intervals, ref_pitches, ref_instruments, est_intervals,
             est_pitches, est_instruments)
    ...
    matching = match_notes(
        ref_intervals, ref_pitches, ref_instruments, est_intervals, est_pitches,
        est_instruments, onset_tolerance, pitch_tolerance, offset_ratio,
